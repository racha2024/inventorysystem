...
namespace inventorysystem.Pages.Rangsit
{
    public class CreateRangsitModel : PageModel
    {
		...
		public void OnPost()
		{
            ...
            try
            {
                String connectionString = "Server=tcp:inventory2929.database.windows.net,1433;Initial Catalog=inventory2929;Persist Security Info=False;User ID=racha;Password={your_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;\r\n";
